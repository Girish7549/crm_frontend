...
import NotesTimeline from '../employee/NotesTimeline'
...
const ActivationDrawer = ({
  ...
  const update_saleActivation_Note = `${baseUrl}/activations/${rowData?._id}`
  console.log('Follow Up id: ', update_saleActivation_Note)
  ...
  const handleSubmit = async () => {
    ...
    const req = await fetch(update_saleActivation_Note, {
      method: 'PUT',
